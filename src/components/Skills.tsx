...
const Skills: React.FC = () => {
  ...
  // Full-Stack / AI Focused - 4 Categories
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'BullMQ / Redis Jobs', level: 82 },
        { name: 'Auth & Security (JWT)', level: 85 },
      ],
    },
    {
      id: '03',
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'LangChainGo', level: 75 },
        { name: 'Data Structures & Algo', level: 85 },
        { name: 'Low-Level Design', level: 80 },
