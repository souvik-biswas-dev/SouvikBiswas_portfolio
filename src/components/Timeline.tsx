...
const milestones = [
    {
        title: 'Genesis',
        description: 'Started with C++ and the fundamentals of programming, building a strong base in problem-solving and OOP.',
        tags: ['C++', 'OOP', 'Foundations']
    },
    {
        title: 'Full Stack',
        description: 'Learned the MERN stack and shipped my first end-to-end web applications with React, Node.js, and MongoDB.',
        tags: ['MERN', 'React', 'MongoDB']
    },
    {
        title: 'Going Deeper',
        description: 'Picked up Next.js and Go, sharpened DSA with 200+ problems, and started studying system and low-level design.',
        tags: ['Next.js', 'Go', 'DSA']
    },
    {
        title: 'AI Integration',
        description: 'Built AI-driven features with the Gemini and OpenAI APIs, including LangChainGo sentiment pipelines.',
        tags: ['Gemini', 'OpenAI', 'LangChainGo']
    },
    {
        title: 'Shipping at Scale',
        description: 'Architected and shipped a multi-tenant school ERP solo — now serving 1,000+ students with Docker and Redis.',
        tags: ['Multi-Tenant', 'Docker', 'Redis']
    },
    {
        title: 'New Grad',
        description: 'Graduating with a B.Tech in CSE and open to full-time roles where I can build real production systems.',
        tags: ['B.Tech CSE', 'Open to Work', 'Full-Time']
    },
];
