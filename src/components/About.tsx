...
const AwardWinningAbout: React.FC = () => {
    ...
    const stats = [
        { label: "PRJ_BUILT", value: "10+", desc: "Projects Built" },
        { label: "DSA_SOLVED", value: "200+", desc: "DSA Problems" },
        { label: "STACK", value: "MERN", desc: "Next.js & Go" },
        { label: "AVAIL", value: "OPEN", desc: "New Grad", active: true },
    ];
                ...
                <div className="mb-16 md:mb-24 relative">
                    ...
                    <div className="about-content-item relative md:absolute md:top-1/2 left-0 md:left-1/4 mt-12 md:mt-0 ml-0 md:ml-20 transform md:-translate-y-1/2 w-full md:w-2/3 pl-6 border-l-2 border-red-500">
                        <p className="text-lg md:text-2xl font-light leading-relaxed text-black dark:text-white mix-blend-difference">
                            I build <span className="font-bold">production-grade full-stack applications</span> with the <span className="font-bold text-red-500">MERN stack</span>, <span className="font-bold text-red-500">Next.js</span>, and <span className="font-bold text-red-500">Go</span>. My focus is engineering robust APIs, <span className="font-bold">multi-tenant architectures</span>, and clean data layers — from a live school ERP serving <span className="font-bold">1,000+ students</span> to tamper-evident financial ledgers.
                        </p>
                        <p className="text-lg md:text-2xl font-light leading-relaxed text-black dark:text-white mix-blend-difference mt-6">
                            I integrate <span className="font-bold">AI</span> deeply into products with the <span className="font-bold">Gemini</span> and <span className="font-bold">OpenAI</span> APIs, and ship reliably using <span className="font-bold">Docker</span>, <span className="font-bold">Redis</span>-backed job queues, and <span className="font-bold">AWS</span>.
                        </p>
                    </div>
                </div>
